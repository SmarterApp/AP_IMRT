...
## Execution
To execute the Item Synchronization Process, refer to the [Execution](../common-tasks/item-sync-execution.md) page in the **Common Tasks** section for the Item Synchronization Process.